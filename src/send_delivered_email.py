...
body = f"Hello {username},<br><br>Your order from {restaurant} has been delivered!<br>"\
       f"Hope to see you again soon. <br><br>Until then,<br>Bobby<br><i>Save, Eat, Repeat!</i> "
